...
export type SeoShopDataQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type SeoShopDataQuery = {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query seoShopData($country: CountryCode, $language: LanguageCode)\n  @inContext(country: $country, language: $language) {\n    shop {\n      name\n      description\n    }\n  }\n': {
    return: SeoShopDataQuery;
    variables: SeoShopDataQueryVariables;
  };
